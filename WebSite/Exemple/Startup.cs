...
namespace WebApplication1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<Crypting>(); //permettra de crypter le mot de passe / donnée sensible du user
            ...
            services.AddTransient<ISessionManager, SessionManager>(); // on ajout le session manager en injection de dép, en transient, permet 
        }
